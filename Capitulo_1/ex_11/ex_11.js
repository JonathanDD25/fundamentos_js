...
// en el operador && = Y, deben umplirse dos condiciones para retornar true.
...
// convertir los valores digitados por el usuario
day = parseInt(day);
...
if(isNaN(day) || isNaN(month) || isNaN(year)) {
    document.writeln("por favor, ingrese unicamente valores numericos para el dia el mes y el año");
